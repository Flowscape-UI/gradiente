...
// node_modules/@lezer/highlight/node_modules/@lezer/common/dist/index.js
...
function buildTree2(data) {
  ...
  function makeTree(type, children2, positions2, length2, lookAhead2, contextHash2, props) {
    if (contextHash2) {
      let pair = [NodeProp2.contextHash, contextHash2];
      props = props ? [pair].concat(props) : [pair];
    }
    if (lookAhead2 > 25) {
      let pair = [NodeProp2.lookAhead, lookAhead2];
      props = props ? [pair].concat(props) : [pair];
    }
...
var ruleNodeProp = new NodeProp2({
  combine(a, b) {
    let cur, root, take;
    while (a || b) {
...
//# sourceMappingURL=chunk-PMU4THGI.js.map
